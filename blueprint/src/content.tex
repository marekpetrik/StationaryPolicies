...
&= \tilde{r}_{\mathrm{h}}(h) + \E^{h, \pi, t+1} \left[ \sum_{k=k_0}^{k_0+t}  r(\tilde{s}_k, \tilde{a}_k, \tilde{s}_{k+1})  \right]  && \text{\cref{thm:sum-rew-eq-sum-rew-rg}} \\
&= \tilde{r}_{\mathrm{h}}(h) + \E^{h, \pi, t+1} \left[ r(\tilde{s}_{k_0}, \tilde{a}_{k_0}, \tilde{s}_{k_0+1}) + \sum_{k=k_0+1}^{k_0+t}  r(\tilde{s}_k, \tilde{a}_k, \tilde{s}_{k+1})  \right] \\
